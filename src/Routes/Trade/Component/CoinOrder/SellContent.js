...
const QuantityBtn = styled.div`
  ...
  & a:last-child {
    color: ${(props) =>
      props.isView === textInputDefault ? "#2b2b2b" : "#115dcb"};
    border-color: ${(props) =>
...
const Content = () => {
  ...
  const handleCalculateCtrl = (number) => {
    let getCalculate = priceNumber + number;
    if (0 > getCalculate) {
      getCalculate = 0;
    }
    setPriceNumber(getCalculate);
  };
          ...
          <Check>
            <span className="custom-radio">
              <input
                ...
                defaultChecked
              />
              <label htmlFor="item_limit_sell">지정가</label>
            </span>
          </Check>
          <Check>
            <span className="custom-radio">
              <input
                type="radio"
                name="item-sell"
                id="item_market_price_sell"
                disabled={true}
              />
              <label htmlFor="item_market_price_sell">시장가</label>
            </span>
          </Check>
          <Check>
            <span className="custom-radio">
              <input
                type="radio"
                name="item-sell"
                id="item_reservation_price_sell"
                disabled={false}
              />
              <label htmlFor="item_reservation_price_sell">예약-지정가</label>
            </span>
          </Check>
        </CheckBox>
      </OptionContainer>
